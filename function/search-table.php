    ...
    <table class="table table-bordered cf">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <?php echo $row['ds_crtr']; ?>
                </td>
                <td>
                    <?php echo $row['ds_crtr_dept']; ?>
                </td>
                <td>
                    ...
                    <?php 
                        ...
                        if($file_validation == "Invalid"){
                            ...
                            if($ds_crtr == $fullname){
                                ...
                                echo "<strong><a class='text-warning' toggle='popover' data-placement='bottom' data-toggle='modal' data-target='#test-form' role='button'>".$file_validation."</a></strong>";
